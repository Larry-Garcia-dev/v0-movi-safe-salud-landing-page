            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6">
              <span className="text-balance">
                ...
                <span className="relative inline-block pr-4">
                  ...
                  <motion.span 
                    className="absolute -bottom-1 left-0 right-4 h-1 bg-gradient-to-r from-orange/80 to-orange-light rounded-full"
                ...
                <span className="relative inline-block pr-5">
                  ...
                  <motion.span 
                    className="absolute -bottom-1 left-0 right-5 h-1 bg-gradient-to-r from-petrol/80 to-petrol-light rounded-full"
                    initial={{ scaleX: 0, originX: 0 }}
                    animate={{ scaleX: 1 }}
